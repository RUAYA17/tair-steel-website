...
export default function RailingsStairsPage() {
  const images = getImagesFrom("railings-stairs");
  ...
  return (
    <main className="min-h-screen bg-transparent text-slate-900 px-4 py-10">
      <div className="max-w-4xl mx-auto space-y-6 text-right">
        ...
        <h1 className="text-3xl font-bold">מעקות ומדרגות</h1>

        <p className="text-base md:text-lg leading-relaxed">
          מעקות בטיחות למדרגות פנים וחוץ, עם אפשרות לשילוב עץ, זכוכית ואלמנטים דקורטיביים בהתאם לסגנון הבית.
        </p>
        <p className="text-base md:text-lg leading-relaxed">
          אנו מייצרים מדרגות ברזל חזקות ועמידות – פתוחות או סגורות – בהתאמה מלאה לחלל הקיים.
        </p>

        {/* גלריית מדרגות ומעקות */}
        <section className="mt-6 space-y-3">
          <h2 className="text-xl font-semibold">דוגמאות למעקות ומדרגות</h2>
          {images.length === 0 ? (
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {images.map((src) => (
                ...
                >
                  <Image
                    src={src}
                    alt="עבודת מסגרות – מעקה או מדרגות ברזל"
                    fill

...
export default function ShedsRoomsPage() {
  const images = getImagesFrom("sheds-rooms");
  ...
  return (
    <main className="min-h-screen bg-transparent text-slate-900 px-4 py-10">
      <div className="max-w-4xl mx-auto space-y-6 text-right">
        ...
        <h1 className="text-3xl font-bold">מחסנים וחדרים</h1>

        <p className="text-base md:text-lg leading-relaxed">
          מחסני ברזל ומבני פלדה קלים – פתרונות אחסון וחדרי עבודה חזקים ועמידים לפי מידה.
        </p>
        <p className="text-base md:text-lg leading-relaxed">
          ניתן לשלב חלונות, דלתות, בידוד תרמי וחיפוי חיצוני לפי הצורך ולפי התקציב.
        </p>

        {/* גלריית מחסנים וחדרים */}
        <section className="mt-6 space-y-3">
          <h2 className="text-xl font-semibold">דוגמאות למחסנים וחדרי עבודה</h2>
          {images.length === 0 ? (
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {images.map((src) => (
                ...
                >
                  <Image
                    src={src}
                    alt="עבודת מסגרות – מחסן או חדר ברזל"
                    fill

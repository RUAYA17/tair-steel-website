...
const texts: Record<Lang, any> = {
  he: {
    ...
    aboutBody: ` 
חברת TAIR STEEL נוסדה בשנת 2013 ומובילה מאז בתחום עבודות המסגרות בצפון הארץ.
אנו מתמחים בתכנון, ייצור והתקנה של מגוון רחב של פרויקטים במתכת – החל ממדרגות ומעקות, דרך גגות ופרגולות, ועד לשערים חשמליים, גדרות, חיפויי מתכת ומבני פלדה תעשייתיים.

החברה מנוהלת על-ידי שני גורמים משלימים:

• תאיר דחלה – איש מקצוע בעל ניסיון רב מאז 2013 בעבודות מסגרות, תכנון, ביצוע ופיקוח בשטח. תאיר אחראי על איכות העבודה, בטיחות, עמידות, ועל הובלת כלל העבודות המעשיות עד לקבלת תוצאה מושלמת.

• רואיה דחלה – מנהלת החברה ובעלת אחריות מלאה על הניהול התפעולי. רואיה מובילה את תחומי השיווק הדיגיטלי, ניתוח הנתונים, ניהול העובדים, הנהלת החשבונות, פיתוח אתר החברה וניהול מערכות מידע מתקדמות. שילוב הידע הניהולי והטכנולוגי שלה מאפשר לחברה לפעול ביעילות ולשמור על סטנדרט שירות גבוה במיוחד.

TAIR STEEL ידועה באמינותה, ברמת הגימור הגבוהה ובשירות אישי ומקצועי לכל לקוח, עם דגש על בטיחות, עמידות ועיצוב מודרני.

אנו מלווים כל לקוח משלב הייעוץ והמדידות, דרך התכנון והייצור, ועד להתקנה מושלמת באתר – תוך הקפדה על דיוק הנדסי, אסתטיקה ומגע אנושי חם.


📍 מיקום: טורעאן, אזור הצפון  
📞 טלפון: 052-848-7823  
✉ דוא״ל: tairdahle@gmail.com  
🌐 אתר: https://tair-steel-website.vercel.app`,
  ...
  ar: {
    ...
    aboutTitle:"من نحن – شركة תאיר دחלה للأعمال المعدنية (TAIR STEEL)",
aboutBody: `من نحن – شركة ثائر دحلة للأعمال المعدنية (TAIR STEEL)

تأسست شركة TAIR STEEL عام 2013، ومنذ ذلك الحين أصبحت من الشركات الرائدة في مجال الأعمال المعدنية في شمال البلاد.
نختص في تصميم، تصنيع وتركيب مشاريع معدنية متنوعة – من الدرج والدرابزين، مرورًا بالأسقف والبرجولات، إلى البوابات الكهربائية، الأسوار، الكسوات المعدنية والهياكل الفولاذية الصناعية.

تدار الشركة من خلال شراكة مهنية تجمع بين الخبرة الميدانية والإدارة الحديثة:

• ثائر دحلة – الخبير الفني المسؤول عن تنفيذ المشاريع منذ عام 2013، يتمتع بخبرة واسعة في الأعمال الميدانية، التخطيط، اللحام، الإشراف وضمان جودة ودقة العمل حتى التسليم النهائي.

• رؤيا دحلة – مديرة الشركة والمسؤولة عن الإدارة التشغيلية. تشرف على التسويق الرقمي، إدارة الحسابات والموظفين، تحليل البيانات، تطوير الموقع وإدارة الأنظمة التقنية المتقدمة. تسهم خبرتها في تحسين الأداء وضمان تجربة مهنية لكل زبون.

تشتهر الشركة بالمصداقية، جودة التشطيب العالية، والخدمة الشخصية، مع التركيز على الأمان، المتانة والتصميم العصري.

نرافق زبائننا من مرحلة الاستشارة والقياسات الميدانية، مرورًا بالتصميم والتصنيع، وحتى التركيب النهائي في الموقع – مع الالتزام بالدقة الهندسية واللمسة الجمالية.
📍 الموقع: طرعان, منطقة الشمال   
📞 هاتف: 052-848-7823  
✉ بريد الكتروني: tairdahle@gmail.com  
,

`,


    whyTitle: "لماذا تختارون محددة تائر دحلة؟",
    ...
    contactTitle: "اتصال",
    contactPhone: "هاتف : 0528487823",
    contactArea: "منطقة العمل: شمال البلاد • العنوان: طرعان • الموقع:   https://tair-steel-website.vercel.app ",
    contactIntro1:
...
aboutBody: `
About the Company – Tair Dahla Metalworks (TAIR STEEL)

TAIR STEEL was founded in 2013 and has since become a leading company in metalwork and steel fabrication across Northern Israel.
We specialize in designing, manufacturing, and installing a wide range of metal projects – from stairs and railings to roofs, pergolas, electric gates, fences, metal cladding, and industrial steel structures.

The company is managed by two complementary roles:

• Tair Dahla – the technical expert and field specialist since 2013. Tair is responsible for hands-on execution, welding, engineering planning, on-site supervision, and ensuring the highest levels of safety, durability, and finishing quality.

• Ruaya Dahla – the company’s operations and administrative manager. Ruaya leads digital marketing, data analysis, employee coordination, financial management, website development, and advanced information systems. Her managerial and technological expertise ensures efficient workflow and an outstanding customer experience.

TAIR STEEL is known for its reliability, high-quality finishing, and personal professional service, with strong emphasis on safety, durability, and modern design.

We accompany each client through every stage of the process – from consultation and measurements, through design and production, to precise on-site installation – ensuring engineering accuracy and aesthetic excellence.


📍 Location: Tur’an, Northern District
📞 Phone: +972-52-848-7823
✉ Email: tairdahle@gmail.com
🌐 Website: https://tair-steel-website.vercel.app`,
